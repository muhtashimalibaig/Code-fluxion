    ...
    <nav
      ...
      <div className='hidden md:flex items-center gap-6 relative'>
        ...
        <div className='relative group'>
          ...
          <div
            className={`absolute left-0 mt-2 w-48 bg-black border border-gray-500 rounded-lg shadow-lg p-2 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200`}>
            <Link
              href='/about-agency'
